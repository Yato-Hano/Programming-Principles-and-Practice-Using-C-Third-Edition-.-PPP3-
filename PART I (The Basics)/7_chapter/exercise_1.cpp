/*
[1]
Modify the calculator program from Chapter 6 to make the input stream an explicit parame-
ter (as shown in §7.4.8), rather than simply using cin. Also give the Token_stream constructor
(§6.8.2) an istream& parameter so that when we figure out how to make our own istreams
(e.g., attached to files), we can use the calculator for those. Hint: Don’t try to copy an
istream.
*/
